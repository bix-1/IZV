...
if __name__ == "__main__":
    df = get_dataframe("../data/accidents.pkl.gz", verbose=True)
    plot_roadtype(df, "../graphs/01_roadtype.png")
    plot_animals(df, "../graphs/02_animals.png")
    plot_conditions(df, "../graphs/03_conditions.png")
